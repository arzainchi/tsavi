...
<template>
    <div class="topnav">
        <BContainer fluid>
            ...
            >
                <div
                    id="collapse navbar-collapse active"
                    class="topnav-menu-content"
                >
                    <ul class="navbar-nav">
                        <!-- Menu data -->
                        ...
                        <li class="nav-item dropdown">
                            ...
                            >
                                ...
                                <router-link
                                    class="col dropdown-item side-nav-link-ref"
                                    :to="{ name: 'master.parents' }"
                                    >Wali Murid</router-link
                                >
                                <router-link
                                    class="col dropdown-item side-nav-link-ref"
                                    :to="{ name: 'master.students' }"
                                    >Murid</router-link
                                >
                                <router-link
                                    class="col dropdown-item side-nav-link-ref"
                                    :to="{ name: 'master.tentors' }"
                                    >Tentor</router-link
                                >
                            </div>
                        </li>
