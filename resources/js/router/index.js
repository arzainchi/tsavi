...
const routes = [
    ...
    },
    {
        path: "/master/roles",
        name: "master.roles",
        meta: { authRequired: true, title: "Master Roles" },
    ...
    },
    {
        ...
        meta: { authRequired: true, title: "Master Roles" },
        component: () => import("../views/master/roles/form.vue"),
    },
    {
    ...
    },
    {
        path: "/master/users",
        name: "master.users",
        meta: { authRequired: true, title: "Master User" },
...
router.beforeEach(async (routeTo, routeFrom, next) => {
    ...
    if (routeTo.meta.title != undefined) {
        document.title =
            routeTo.meta.title +
            " | Skote Laravel 10 + Vue 3 Admin & Dashboard";
    }
