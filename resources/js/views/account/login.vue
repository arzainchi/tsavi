          ...
          <BCard no-body class="overflow-hidden">
            ...
            <BCardBody class="pt-0">
              ...
              <BForm class="p-2" action="javascript:void(0)" method="POST">
                <slot />
                <BFormGroup id="input-group-1" label="Username" label-for="input-1" class="mb-3">
                  <BFormInput id="input-1" name="username" v-model="auth.username" type="text" placeholder="Enter Username"></BFormInput>
                </BFormGroup>
